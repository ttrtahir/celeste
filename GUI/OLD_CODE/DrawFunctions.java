        ...
        public static void drawOrbits(ArrayList<ArrayList<double[]>> celestialPositions) {
                ...
                for (int h = 0; h < celestialPositions.size(); h++) {
                        for (int i = 0; i < celestialPositions.get(h).size() - 1; i++) {
                                if (celestialPositions.get(h).get(i + 1)[0] == 0
                                                && celestialPositions.get(h).get(i + 1)[1] == 0)
                                        continue;
                                ...
                                g.drawLine(
                                                ...
                                                (int) ((celestialPositions.get(h).get(i)[1] / SCALE) + FRAME_HEIGHT / 2
                                                                - (focusScale[1] / SCALE)),
                                                (int) ((celestialPositions.get(h).get(i + 1)[0] / SCALE)
                                                                + FRAME_WIDTH / 2
                                                                - (focusScale[0] / SCALE)),
                                                (int) ((celestialPositions.get(h).get(i + 1)[1] / SCALE)
                                                                + FRAME_HEIGHT / 2
                                                                - (focusScale[1] / SCALE)));
                        }
                }
