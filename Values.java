...
public class Values {
    ...
    public static double[][] velocity = {
            ...
            { 35.05251577575409, -20.3926687625899, 0.00170974277401292 },}; // 12
    ...
    public static final Color[] COLORS = { new Color(0xffde3b), new Color(0x009973), new Color(0xffad33),
            ...
            new Color(0x99ccff), new Color(0xa1a2a9), new Color(0x0000ff), new Color(0x99d6ff), new Color(0xFF0000) };

    public static final int[] SIZES = { 50, 3, 6, 7, 1, 4, 43, 36, 1, 16, 15 ,5};
