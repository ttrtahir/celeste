...
/**
 * Contains information and methods for the Solar System.
 */
public class Values {
        /**
         * Stores the initial x,y,z coordinates for the planets.
         */
        ...
        /**
         * Stores the initial x,y,z velocity for the planets.
         */
        public static double[][] velocity = {
                        ...
                        { 47, -43.49, -3.3 }, }; // 12
         /**
         * Stores the mass for the planets.
         */
        public static double[][] mass = {
         ...
         /**
         * Stores the color for each planet.
         */
        ...
        /**
         * Stores the size for each planet.
         */
